const options = [
    ...
    "$10000 worth of silica gel.",
    "$13 worth of Taco Bell",
    "$15 minimum wage.",
    "$16000 in cash a kilo of hashish and eight belly dancers.",
    "$2 beer pitcher night at the base bowling alley.",
    "$20 Tinnies",
    "$20 tinnies",
    "$20000 trip from Honduras to Texas hiding in the back of the troka.",
    "$200/hour",
    ...
    "10000 shrieking teenage girls.",
    "10000 Syrian refugees.",
    ...
    "100000 dollars alcohol and 4 weeks of vacation.",
    "100% accurate gaydar.",
    ...
    "50000 volts straight to the nipples.",
    ...
    "70000 gamers sweating and farting inside an airtight steel dome.",
    "70's bush.",
    ...
    "A 'business trip.'",
    "A $1000 check from Cards Against Humanity!",
    "a $100 plaid shirt",
    "A $19.99 do it yourself wedding",
    "A $2000 enlistment bonus that definitely wasn't worth it.",
    ...
    "A blood transfusion from a teen with at least 10000 Instagram followers.",
    ...
    "A cement truck filled with 20000 lbs. of HME.",
    ...
    "Accidentally broadcasting an NSFW video to 5000 people.",
    ...
    "Barebacking.",
    "Barely making $25000 a year.",
    "Barely making £15000 a year.",
    "Barf.",
    ...
    "Climbing a mountain.",
    "Climbing a tree.",
    "Climbing and breaking a pole that turns out to be a $300000 sculpture",
    ...
    "Fucking up Silent Night in front of 3000 parents.",
    ...
    "Harnessing the miraculous power of the atom to slaughter 200000 Japanese people.",
    ...
    "Her dry scaly hands.",
    "her fine foot straight leg and quivering thigh and the demesnes that there adjacent lie",
    "Her first boyfriend",
    "Her first period",
    ...
    "Loading 10000 learnin' books onto a B-52 and dropping them over Alabama.",
    ...
    "My hot cousin.",
    "My hot neighbor",
    "my house my household stuff my field my barn my horse my ox my ass my any thing",
    ...
    "Nataniel.",
    "Nathaniel Hawthorne",
    "Nathaniel Joseph Nicholas Philip Walter Sugarsop and the rest",
    "Nation-billing.",
    ...
    "Sending $3000 on ski equipment that sits in the front hall closet for 15 years.",
    ...
    "Spelunking.",
    "Spending $12000 a year on dildos",
    "Spending $20 billion on the stupid wall.",
    "Spending $30000 on a penguin called Happy Feet just to have it eaten by a shark",
    ...
    "The Ultimate Yule Log Play this card and win the round. The gift that keeps on giving.",
    ...
    "Two Floridians $10000 in cash five crack pipes and a baby fucking alligator.",
    "Two girls one cup.",
...
module.exports = getRandomOption;